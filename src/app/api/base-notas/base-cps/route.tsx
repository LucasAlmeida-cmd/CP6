...
export async function POST(request:Request) {
    ...
    const{ id,nomeAluno,materia,avaliacao,notaCP, data, feedback,notaCP2, data2, feedback2} = await request.json();//Podemos receber os dados do request realizando
    ...
    const notas = { id,nomeAluno,materia,avaliacao,notaCP, data, feedback,notaCP2, data2, feedback2} as TipoNotaCP;
